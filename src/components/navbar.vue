    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item active">
          <router-link class="nav-link" to="/home" exact>Home <span class="sr-only">(current)</span></router-link>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <router-link class="dropdown-item" to="/something-else">Something else here</router-link>
          </div>
        </li>
        <li class="nav-item">
          <router-link class="nav-link disabled" to="/disabled">Disabled</router-link>
        </li>
      </ul>
